...
let githubLink = "http://github.com/chimayo/chimayo"

// Specify more information about your project
let info =
  [ "project-name", "Chimayo.Ssis"
    "project-author", "Chimayo community"
    "project-summary", "Chimayo is a library for creating and manipulating SQL Server Integration Services packages with F# code."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Chimayo.Ssis" ]
