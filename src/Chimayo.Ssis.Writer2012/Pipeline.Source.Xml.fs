module Chimayo.Ssis.Writer2012.Pipeline.Source.Xml
                    ...
                    yield createProperties
                        [
                            yield createSimpleProperty "UserComponentTypeName" "System.String"
                                      @"Microsoft.SqlServer.Dts.Pipeline.XmlSourceAdapter, Microsoft.SqlServer.XmlSrc, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91"
                            yield! c |> buildSourceProperties
                            yield! c |> buildSchemaProperties
                            yield createProperty @"XMLIntegerMapping" "System.Int32"
                                      None false 
                                      (Some @"Microsoft.SqlServer.Dts.Pipeline.XmlSourceAdapter+XMLIntegerMappingConverter, Microsoft.SqlServer.XmlSrc, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91")
                                      None false false
                                      []
                                      [
                                          c 
