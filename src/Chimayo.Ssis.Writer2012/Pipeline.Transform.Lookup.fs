module Chimayo.Ssis.Writer2012.Pipeline.Transform.Lookup
        ...
        return
                          ...
                          |> XmlElement.setContent
                            [
                                createProperty 
                                    ...
                                    (Some "Microsoft.DataTransformationServices.Controls.ModalMultilineStringEditor, Microsoft.DataTransformationServices.Controls, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91")
            ...
            |> XmlElement.setAttributes
                [
                    ...
                    yield createAttribute "componentClassID" "{671046B0-AA63-4C9F-90E4-C06E0B710CE3}"
