module Chimayo.Ssis.Reader2008.Pipeline.Source.Xml
...
let clrTypeNames = 
    [
       "Microsoft.SqlServer.Dts.Pipeline.XmlSourceAdapter, Microsoft.SqlServer.XmlSrc, Version=10.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91"
    ]
