module Chimayo.Ssis.Reader2008.ExecuteSqlTask
...
let taskNames =
    [
        "Microsoft.SqlServer.Dts.Tasks.ExecuteSQLTask.ExecuteSQLTask, Microsoft.SqlServer.SQLTask, Version=10.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91"
        "STOCK:SQLTask"
    ]
...
let readResultBindings nav =
    let fn nav' = 
        ...
        let variable = nav' |> Extractions.anyString "self::*/@SQLTask:DtsVariableName" "" |> Common.getFullyQualifiedVariableName <| nav'
        resultName, variable
    ...
    CftExecuteSql
        {
            ...
            isStoredProc = objectData |> Extractions.anyBool "self::*/@SQLTaskLIsStoredProc" false
